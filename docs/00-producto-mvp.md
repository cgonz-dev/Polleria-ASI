...
El MVP de Venta en Pluma ahora incluye captura rápida, cálculo automático, guardado en Supabase, ticket imprimible de 80mm, bandeja de tickets pendientes por imprimir, corte del día, Clientes Preferenciales y uso de branding Pollería ASI en la interfaz.
...
El corte del día está pensado para revisión operativa interna: muestra totales, tickets, servicios extra, usuario que cerró, efectivo contado, diferencia e impresión simple del resumen para administración.

Los clientes con condiciones especiales se nombran oficialmente **Clientes Preferenciales**. No se usa el término proveedor dentro del sistema para evitar confusión con proveedores reales de insumos.
...
- Clientes Preferenciales para manejar compradores frecuentes o condiciones especiales.
...
- Corte del día para revisar total vendido, efectivo esperado, pollos, kg, preparación, servicios extra, actividad por usuario, estado de cierre e impresión administrativa.
...
El sistema usará Supabase PostgreSQL como base de datos compartida para múltiples cajeros y dispositivos. La primera versión del modelo contempla configuración del negocio, usuarios internos, Clientes Preferenciales, ventas en pluma y cancelaciones de venta.

Para Venta en Pluma, cada venta guardará snapshots de precio, cliente, tipo de peso, preparación y servicios extra. Esto evita que ventas históricas cambien cuando se modifique el precio general o los precios de un Cliente Preferencial.
...
La pantalla de corte muestra hora de última actualización, avisa si el resumen vivo ya no coincide con el cierre guardado y usa una vista responsive con tarjetas en móvil para evitar tablas difíciles de leer. También desglosa despielada, pechuga fileteada y servicios extra.
...
Preparación = cantidad de pollos * preparación por pollo
